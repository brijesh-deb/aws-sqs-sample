...
public class JmsConfig {
    ...
    public JmsConfig(@Value("${cloud.aws.region.static}") String awsRegion)
    {
        connectionFactory = SQSConnectionFactory.builder().withRegion(Region.getRegion(Regions.fromName(awsRegion))).build();
    }
